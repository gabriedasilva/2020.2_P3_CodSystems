    ...
    <div style="background-color: #EEEEEE;" class="flex-fill flex-grow-1">
        ...
        <div class="d-flex flex-row justify-content-center w-auto shadow-sm bg-light h-75 p-1 m-4">
            <div class="d-flex flex-column justify-content-center w-100 h-100">
                <a href="<?php echo base_url('UsuarioWebController') ?>" class="btn btn-outline-primary d-flex align-items-center justify-content-center w-auto h-50 shadow-sm p-1 m-2 rounded">
                ...
                <a href="<?php echo base_url('UsuarioMobController') ?>" class="btn btn-outline-primary d-flex align-items-center justify-content-center w-auto h-50 shadow-sm p-1 m-2 rounded">
            ...
            <div class="d-flex flex-column justify-content-center w-100 h-100">
                ...
                <a href="<?php echo base_url('DisciplinasController') ?>" class="btn btn-outline-primary d-flex align-items-center justify-content-center w-auto h-50 shadow-sm p-1 m-2 rounded">
